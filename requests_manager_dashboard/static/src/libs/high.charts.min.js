 ...
 * Original file: /npm/highcharts@12.2.0/highcharts.js
 *
  ...
  (() => {
          ...
          a &&
            a.call(
              ...
              !!w.supportsPassiveEvents && {
                passive:
                  void 0 === s.passive ? -1 !== e.indexOf("touch") : s.passive,
                capture: !1,
              }
            ),
            r[e] || (r[e] = []);
        ...
        return (
          t0(t, (e, i) => {
            ...
            -1 === t6.allowedAttributes.indexOf(i) && (s = !1),
              -1 !==
                ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) &&
                (s =
                  tQ(e) &&
                  t6.allowedReferences.some((t) => 0 === e.indexOf(t))),
              s ||
                (tK(33, !1, void 0, { "Invalid attribute in config": `${i}` }),
                delete t[i]),
      ...
      constructor(t, e, i, s, o, r, a) {
        ...
        a || l.css(this.getStyle(s || {})),
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              iv.createTextNode("Created with Highcharts 12.2.0")
            ),
    ...
    let si = a,
      ...
      sU = (t, e) =>
        sW(
          ...
          void 0,
          void 0,
          sF(t.options.allowDecimals, e < 0.5 || void 0 !== t.tickAmount),
          !!t.tickAmount
        );
    ...
    class s$ {
      ...
      translate(t, e, i, s, o, r) {
        ...
        let h = a.minPixelPadding,
          l =
            (a.isOrdinal || a.brokenAxis?.hasBreaks || (a.logarithmic && o)) &&
            a.lin2val,
          d = 1,
          c = 0,
      ...
      getPlotLinePath(t) {
        ...
        return (
          sE(this, "getPlotLinePath", b, function (t) {
            (g = f =
              (c = sS(
                (c = sF(c, e.translate(a, void 0, void 0, r))),
                -1e9,
                1e9
              )) + d),
              (u = m = h - c - d),
      ...
      setTickInterval(t) {
        let {
          ...
          M,
          S =
            sN(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0,
          T,
          C,
          A,
          P;
          ...
          sN(this.max) &&
            ...
            (n &&
              (this.positiveValuesOnly &&
                !t &&
                0 >= Math.min(this.min, sF(o, this.min)) &&
                sL(10, !0, i),
      ...
      setScale() {
        ...
        this.alignToOthers()
          ? (e && "yAxis" === t && e.buildStacks(),
            ...
            this.isDirty ||
              (this.isDirty =
                o || this.min !== this.old?.min || this.max !== this.old?.max))
          : e && e.cleanStacks(),
      ...
      setAxisSize() {
        let t = this.chart,
          ...
          o = (this.width = Math.round(
            sX(sF(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth)
          )),
          r = (this.height = Math.round(
            sX(sF(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)
          )),
          a = (this.top = Math.round(
            sX(sF(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop)
          )),
          n = (this.left = Math.round(
            sX(sF(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft)
          ));
        ...
        if (i) {
          if (
            ...
            for (let i of p)
              (i === r || (i && i >= -90 && i <= 90)) &&
                (e =
                  (t = h(Math.abs(a / Math.sin(sk * i)))) + Math.abs(i / 360)) <
                  c &&
                ((c = e), (d = i), (l = t));
          }
        } else l = h(0.75 * a);
        ...
        if (
          ...
          v &&
            ...
            (k +=
              f *
              (i
                ? sF(c.y, t.tickRotCorr.y + f * c.distance)
                : sF(c.x, f * c.distance)))),
      ...
      renderLabel(t, e, i, s) {
        ...
        n ||
          ...
          o.chart.styledMode ||
            n.css(
              os(
                { fontSize: "0.8em", textOverflow: i && !a ? "" : "ellipsis" },
                t.style
              )
            ),
          n.add());
      ...
      runPointActions(t, e, i) {
        ...
        this.unDocMouseMove ||
          ((this.unDocMouseMove = o2(
            ...
            "mousemove",
            (t) => oQ[rr.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)
          )),
      ...
      (t.seriesTypes = w.seriesTypes),
        ...
        (t.seriesType = function (i, s, o, r, a) {
          ...
          if (
            ...
            e(i, rb(t.seriesTypes[s] || function () {}, r)),
    ...
    class r0 {
      ...
      getCyclic(t, e, i) {
        ...
        !e &&
          (rN(
            (o = rK("color" === t ? this.options.colorIndex : void 0, this[a]))
          )
            ? (s = o)
        ...
        (g = g || r),
          u
            ? (p.push.apply(p, r0.keepPropsForPoints),
              ...
              t.data &&
                (t.dataSorting && rF(i.options.dataSorting, t.dataSorting),
      ...
      colorizeItem(t, e) {
        ...
        if (
          ...
          r?.css(an(e ? this.itemStyle : i)),
            ...
            n &&
              n.attr(p(c && n.isMarker ? t.pointAttribs() : { fill: t.color })),
            s?.attr(
      ...
      temporaryDisplay(t) {
        ...
        if (t)
          ...
          for (
            ...
            ("none" === aF(e, "display", !1) || e.hcOricDetached) &&
              ((e.hcOrigStyle = {
          ...
          if (
            ...
            if (
              ...
              o &&
                ...
                (r =
                  o.getBBox().height + i.distance + Math.max(t.offset || 0, 0)),
              r)
            ) {
              o?.destroy();
              break;
        ...
        for (let t of (this.hoverPoints?.forEach((t) => t.setState()), e)) {
          ...
          if (
            ...
            for (let e of t.series) {
              ...
              A ??
                (A = { dataMin: Number.MAX_VALUE, dataMax: -Number.MAX_VALUE }),
                aG(t.dataMin) &&
                  aG(t.dataMax) &&
          ...
          (!t.isOrdinal || t.options.overscroll || 1 !== k || o) &&
            ...
            C > G && ((C = G), k >= 1 && (T = C - z)),
            (o ||
              (t.series.length && (T !== O || C !== E) && T >= X && C <= G)) &&
              (r
        ...
        setOffset(t, e, i, s, o, r) {
          ...
          if (h && p) {
            ...
            (p.x -= o),
              ...
              i &&
                no.prototype.justifyDataLabel.call(n, h, a, h.alignAttr, t, p),
              h.attr({
                x: h.alignAttr.x,
                y: h.alignAttr.y,
                rotation: l.rotation,
    ...
    (nF.defaultOptions = nR(nN.defaultOptions, {
      ...
      nz(nF.prototype, { singleStacks: !1 }),
    ...
    !(function (t) {
      ...
      function n(t, e) {
        ...
        if (hh(t) && !hh(e))
          ...
          if (hh(t) && hh(e))
            for (s = Math.max(t.length, e.length); s--; ) i[s] = hd(t[s], e[s]);
        } else i = hd(t, e);
        return i;
      }
      function h(t) {
                ...
                e.forEach((t) => {
                  (t.dataLabels || []).forEach((e) => {
                    ...
                    s &&
                      ...
                      (e.lineHeight =
                        i.renderer.fontMetrics(e.text || e).h + 2 * e.padding),
                      (t.distributeBox = {
                        target:
    ...
    function lr(t) {
      let e = t.length,
        ...
        s = (t, e) => {
          for (let i of t) if (h7({ x: i[0], y: i[1] }, e)) return !0;
          return !1;
        },
        o,
        r,
          ...
          t.oldOpacity !== i &&
            (t.hasClass("highcharts-data-label")
              ? (t[i ? "removeClass" : "addClass"](
                ...
                li(e, "afterHideOverlappingLabel"))
              : t.attr({ opacity: i })),
          (t.isOld = !0)),
        s
      );
    ...
    let lh = {
        compose: function (t) {
          ...
          e.hideOverlappingLabels ||
            ((e.hideOverlappingLabels = lr), lt(t, "render", ln));
        },
      },
      ...
      lm = { radius: 0, scope: "stack", where: void 0 },
      lx = ld,
      ly = ld;
        ...
        for (let s of this.points) {
          ...
          if ("roundedRect" === s.shapeType && a) {
            ...
            !g &&
              ...
              g || (g = "end");
            let u =
              Math.min(lf(o.radius, n), n / 2, "all" === g ? h / 2 : 1 / 0) ||
              0;
            "end" === g && (p && (d -= u), (c += u)),
    ...
    function lk(t, e) {
      return lg(t) || (t = { radius: t || 0 }), lu(lm, e, t);
    }
    function lw() {
    ...
    !(function (t) {
      function e(t, e) {
        ...
        (
          ...
          function () {
            return (
              this.chartWidth <= lP(i.maxWidth, Number.MAX_VALUE) &&
              this.chartHeight <= lP(i.maxHeight, Number.MAX_VALUE) &&
              this.chartWidth >= lP(i.minWidth, 0) &&
              this.chartHeight >= lP(i.minHeight, 0)
            );
          }
      ...
      t.compose = function (t) {
        ...
        return (
          s.matchResponsiveRule ||
            lT(s, { matchResponsiveRule: e, setResponsive: i }),
          t
        );
      };
    })(b || (b = {}));
      ...
      (w.timers = tB.timers),
      {
        compose: function (t, e, i) {
          ...
          if (!e.symbolCustomAttribs.includes("borderRadius")) {
            ...
            lc(t, "afterColumnTranslate", lv, { order: 9 }),
