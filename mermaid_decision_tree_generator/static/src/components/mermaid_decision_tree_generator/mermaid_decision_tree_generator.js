...
class KnapsackFlowchart extends Component {
    static template = "mermaid_decision_tree_generator.KnapsackFlowchartTemplate";
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            if (context.log_id) {
                ...
                this.flowchart = log[0].mermaid_flowchart;
            } else {
...
registry.category("actions").add("knapsack_flowchart", KnapsackFlowchart);